...
import { User, Mail, Lock, Eye, EyeOff, Code2, Loader2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#08080f] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/3 w-64 h-64 bg-violet-600/8 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">Start tracking your coding journey</p>
        </div>
